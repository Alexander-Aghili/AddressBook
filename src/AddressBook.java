...
//			
//			if (searchName.compareTo(contactList.get(middle).getLastName()) == 0) {
//				System.out.println("Contact number " + (middle + 1) 
//						+ " has the last name " + searchName + " and details are listed below.");
//				System.out.println(contactList.get(middle));
//				return;
//			}
//			
//			if (searchName.compareTo(contactList.get(middle).getLastName()) < 0)
...
//		System.out.println("No contact contains the last name " + searchName);
	}
